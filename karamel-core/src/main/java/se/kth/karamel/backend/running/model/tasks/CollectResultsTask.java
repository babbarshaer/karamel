 ...
 * @author kamal
 */
public class CollectResultsTask extends Task {

  private final String recipe;
  private String json;

  public CollectResultsTask(MachineEntity machine, String recipe, String json) {
  ...
  public static String makeUniqueId(String machineId, String recipe) {
    return CollectResultsTask.class.getSimpleName() + recipe +  machineId;
  }
